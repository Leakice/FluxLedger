...
function open(card = null) {
  Object.assign(form, { id: null, name: '', last4: '', noLast4: false, network: 'Visa', color: colors[0] }, card || {});
