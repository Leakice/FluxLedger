  export const dictionary = {
    'Annual software and cloud plan':'年度软件与云服务订阅','Weekend train tickets':'周末往返火车票',
    'Equal-width flows show routes; labels show repayment amounts.':'流线等宽表示还款路径，金额以标注为准。',
    'Demo apartment rent':'演示公寓房租','Weekly groceries':'每周超市采购',
    'Dinner with friends':'朋友聚餐','Music and cloud storage':'音乐与云存储订阅',
    'Transit pass':'公共交通月票','Demo credit limit':'演示信用额度',
    'Desk and chair':'书桌与座椅','Demo laptop upgrade':'演示笔记本升级',
    'Desk paid in full':'书桌消费全额还款','Laptop first repayment':'笔记本首笔还款',
    'Electricity and internet':'电费与宽带','Dinner paid in full':'聚餐消费全额还款',
    'Running shoes':'运动跑鞋','Laptop second repayment':'笔记本第二笔还款',
    'Museum day trip':'博物馆一日游',
    ...
    'Sign in with ChatGPT':'使用 ChatGPT 登录','Sign out':'退出登录','Cloud account':'云端账户',
    'Save failed':'保存失败',
    'Sync conflict — cloud data reloaded. Your unsaved changes were kept as a local backup.':'同步冲突——已重新加载云端数据；您未同步的修改已保留为本地备份，可恢复。',
    'Restore my changes':'恢复我的修改','Restore unsaved copy':'恢复未同步副本',
    ...
    'Sync backups are full. Export your data, then use "Discard unsaved changes" in Data management before restoring copies.':'同步冲突备份已达上限——请先导出数据，再在数据管理中使用「放弃未同步修改」，然后逐份恢复。',
    'Discard unsaved changes':'放弃未同步修改','Confirm: discard unsaved changes':'确认：放弃未同步修改',
...
Object.assign(dictionary, {"Data management":"数据管理","Backup & restore":"备份与恢复","Move your ledger between browsers with a complete data backup.":"用完整数据备份在浏览器之间迁移账本。","Export data":"导出数据","Download transactions and cards as a JSON backup.":"将交易和银行卡下载为 JSON 备份。","Import data":"导入数据","Restore a JSON backup or a legacy CSV export.":"导入 JSON 备份或旧版 CSV 导出文件。","Ready to import":"可以导入","This replaces the current local data.":"导入后将替换当前本机数据。","Import and replace":"导入并替换","Data exported":"数据已导出","Data imported":"数据已导入","The selected file is empty.":"所选文件为空。","No transaction data found.":"文件中没有可识别的交易数据。","Transaction data is invalid.":"交易数据格式无效。","Card data is invalid.":"银行卡数据格式无效。","The file references a card that does not exist.":"文件引用了不存在的银行卡。","The selected file is not valid JSON or CSV.":"所选文件不是有效的 JSON 或 CSV。","Could not read this file.":"无法读取该文件。"});
...
Object.assign(dictionary, { 'Share of capacity': '占资金容量' });

Object.assign(dictionary, { 'Repayment records':'还款记录' });
