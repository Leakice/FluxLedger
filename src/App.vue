...
import { defaultCards, entryKinds, creditLimit, periodEnd, buildFlowModel, withCreditAccountCards } from './ledger';
...
const bankCards=ref(withCreditAccountCards(read('fluxledger-cards-v1',defaultCards)));
